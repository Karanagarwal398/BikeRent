...
import com.example.karan.bikerent.fragment.BookingFragment;
import com.example.karan.bikerent.fragment.BusinessFragment;
import com.example.karan.bikerent.fragment.InformationFragment;
import com.example.karan.bikerent.fragment.SearchBikeFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.action_booking) {
                    ...
                    bookingFragment = new SearchBikeFragment();
...
//                    ((CustomApplication)getApplication()).getShared().setUserData("");
                    ...
                    Intent logoutIntent = new Intent(HomeActivity.this, activity_SignIn.class);
    ...
    public void shareText() {
        ...
        intent.putExtra(android.content.Intent.EXTRA_SUBJECT, "Bikes Rental");
